...
from kr8.cli.ws.ws_cli import ws_cli
from kr8.cli.k.k_cli import k_cli
from kr8.utils.log import set_log_level_to_debug, logger
...
def auth(
    ...
    from kr8.cli.operator import authenticate_user
...
def login(
    ...
    * `phi login`
    ...
    from kr8.cli.operator import sign_in_using_cli
...
def ping(
    ...
    from kr8.api.user import user_ping
    from kr8.cli.console import print_info
...
def set(
    ...
    """
    from kr8.workspace.operator import set_workspace_as_active
...
def start(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.cli.console import log_config_not_available_msg
    from kr8.cli.operator import start_resources, initialize_phi
...
def stop(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.cli.console import log_config_not_available_msg
    from kr8.cli.operator import stop_resources, initialize_phi
    from kr8.infra.type import InfraType
...
def patch(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.cli.console import log_config_not_available_msg
    from kr8.cli.operator import patch_resources, initialize_phi
    from kr8.infra.type import InfraType
