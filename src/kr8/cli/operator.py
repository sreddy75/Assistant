...
from kr8.cli.settings import phi_cli_settings, PHI_CLI_DIR
...
def authenticate_user() -> None:
    ...
    """
    from kr8.api.user import authenticate_and_get_user
    from kr8.api.schemas.user import UserSchema
    from kr8.cli.auth_server import (
...
def sign_in_using_cli() -> None:
    ...
    from kr8.api.user import sign_in_user
    from kr8.api.schemas.user import UserSchema, EmailPasswordAuthSchema
