...
def create(
    ...
    from kr8.workspace.operator import create_workspace
...
def setup(
    ...
    from kr8.workspace.operator import setup_workspace
...
def up(
    ...
    from kr8.workspace.operator import start_workspace
    from kr8.utils.resource_filter import parse_resource_filter
...
def down(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.workspace.config import WorkspaceConfig
    from kr8.workspace.operator import stop_workspace
    from kr8.utils.resource_filter import parse_resource_filter
...
def patch(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.workspace.config import WorkspaceConfig
    from kr8.workspace.operator import update_workspace
    from kr8.utils.resource_filter import parse_resource_filter
...
def delete(
    ...
    from kr8.cli.config import PhiCliConfig
    from kr8.workspace.operator import delete_workspace
