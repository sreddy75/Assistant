...
from kr8.cli.console import print_heading, print_info
from kr8.cli.settings import phi_cli_settings
from kr8.api.schemas.user import UserSchema
from kr8.api.schemas.workspace import WorkspaceSchema, WorkspaceDelete
from kr8.utils.log import logger
from kr8.utils.json_io import read_json_file, write_json_file
...
class PhiCliConfig:
    ...
    def delete_ws(self, ws_root_path: Path) -> None:
        ...
        if self.user is not None and ws_config.ws_schema is not None:
            ...
            from kr8.api.workspace import delete_workspace_for_user
