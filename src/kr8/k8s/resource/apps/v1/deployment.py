...
from kr8.k8s.resource.apps.v1.deployment_strategy import DeploymentStrategy
from kr8.k8s.resource.core.v1.pod_template_spec import PodTemplateSpec
from kr8.k8s.resource.meta.v1.label_selector import LabelSelector
from kr8.utils.dttm import current_datetime_utc_str
