...
from kr8.app.base import AppBase
from kr8.app.context import ContainerContext
from kr8.k8s.app.context import K8sBuildContext
from kr8.k8s.enums.restart_policy import RestartPolicy
from kr8.k8s.enums.image_pull_policy import ImagePullPolicy
from kr8.k8s.enums.service_type import ServiceType
from kr8.utils.log import logger

if TYPE_CHECKING:
    from kr8.k8s.resource.base import K8sResource
...
class K8sApp(AppBase):
            ...
            if self.enable_https:
                ...
                if self.acm_certificate_summary_file is not None and isinstance(
                    ...
                    if self.acm_certificate_summary_file.exists() and self.acm_certificate_summary_file.is_file():
                        from kr8.aws.resource.acm.certificate import CertificateSummary
    ...
    def get_ingress_name(self) -> str:
        from kr8.utils.defaults import get_default_ingress_name
    ...
    def get_cr_policy_rules(self) -> List[Any]:
        from kr8.k8s.create.rbac_authorization_k8s_io.v1.cluster_role import (
            PolicyRule,
        )
    ...
    def build_resources(self, build_context: K8sBuildContext) -> List["K8sResource"]:
        from kr8.k8s.create.apps.v1.deployment import CreateDeployment
        from kr8.k8s.create.base import CreateK8sResource
        from kr8.k8s.create.common.port import CreatePort
        from kr8.k8s.create.core.v1.config_map import CreateConfigMap
        from kr8.k8s.create.core.v1.container import CreateContainer
        from kr8.k8s.create.core.v1.namespace import CreateNamespace
        from kr8.k8s.create.core.v1.secret import CreateSecret
        from kr8.k8s.create.core.v1.service import CreateService
        from kr8.k8s.create.core.v1.service_account import CreateServiceAccount
        from kr8.k8s.create.core.v1.volume import (
            CreateVolume,
            HostPathVolumeSource,
            AwsElasticBlockStoreVolumeSource,
            VolumeType,
        )
        from kr8.k8s.create.networking_k8s_io.v1.ingress import CreateIngress
        from kr8.k8s.create.rbac_authorization_k8s_io.v1.cluste_role_binding import CreateClusterRoleBinding
        from kr8.k8s.create.rbac_authorization_k8s_io.v1.cluster_role import CreateClusterRole
        from kr8.k8s.resource.base import K8sResource
        from kr8.k8s.resource.yaml import YamlResource
        from kr8.utils.defaults import get_default_volume_name, get_default_sa_name
            ...
            if self.volume_type == AppVolumeType.AwsEbs:
                if self.ebs_volume_id is not None or self.ebs_volume is not None:
                    ...
                    if ebs_volume_id is None and self.ebs_volume is not None:
                        from kr8.aws.resource.ec2.volume import EbsVolume
