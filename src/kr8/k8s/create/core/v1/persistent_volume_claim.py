...
from kr8.k8s.enums.pv import PVAccessMode
from kr8.k8s.resource.core.v1.persistent_volume_claim import (
    PersistentVolumeClaim,
    PersistentVolumeClaimSpec,
)
from kr8.k8s.resource.core.v1.resource_requirements import (
