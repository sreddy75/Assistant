...
from kr8.app.group import AppGroup
from kr8.resource.group import ResourceGroup
from kr8.k8s.app.base import K8sApp
from kr8.k8s.app.context import K8sBuildContext
from kr8.k8s.api_client import K8sApiClient
...
class K8sResources(InfraResources):
    ...
    def create_resources(
        ...
        from kr8.cli.console import print_info, print_heading, confirm_yes_no
        from kr8.k8s.resource.types import K8sResourceInstallOrder
    ...
    def save_resources(
        ...
        from kr8.cli.console import print_info, print_heading
        from kr8.k8s.resource.types import K8sResourceInstallOrder
