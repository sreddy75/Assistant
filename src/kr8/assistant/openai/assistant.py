...
from kr8.assistant.openai.file import File
from kr8.assistant.openai.exceptions import AssistantIdNotSet
from kr8.tools import Tool, Toolkit
from kr8.tools.function import Function
...
class OpenAIAssistant(BaseModel):
    ...
    def print_response(self, message: str, markdown: bool = False) -> None:
        ...
        from kr8.assistant.openai.thread import Thread
