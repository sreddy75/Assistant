...
from kr8.aws.app.base import AwsApp
from kr8.aws.app.context import AwsBuildContext
from kr8.aws.api_client import AwsApiClient
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from kr8.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from kr8.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from kr8.aws.resource.types import AwsResourceInstallOrder
