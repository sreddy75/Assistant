...
from src.backend.kr8.docker.app.base import DockerApp
from src.backend.kr8.docker.app.context import DockerBuildContext
from src.backend.kr8.docker.api_client import DockerApiClient
...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from src.backend.kr8.docker.resource.types import DockerContainer, DockerResourceInstallOrder
