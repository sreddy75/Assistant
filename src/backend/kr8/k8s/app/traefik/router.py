...
from src.backend.kr8.k8s.app.base import (
    K8sApp,
...
from src.backend.kr8.k8s.app.traefik.crds import ingressroute_crd, middleware_crd
...
class TraefikRouter(K8sApp):
    ...
    def add_app_resources(self, namespace: str, service_account_name: Optional[str]) -> List[Any]:
        from src.backend.kr8.k8s.create.apiextensions_k8s_io.v1.custom_object import CreateCustomObject
