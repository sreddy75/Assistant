...
from src.backend.kr8.app.group import AppGroup
from src.backend.kr8.resource.group import ResourceGroup
from src.backend.kr8.k8s.app.base import K8sApp
from src.backend.kr8.k8s.app.context import K8sBuildContext
from src.backend.kr8.k8s.api_client import K8sApiClient
from src.backend.kr8.k8s.create.base import CreateK8sResource
from src.backend.kr8.k8s.resource.base import K8sResource
from src.backend.kr8.k8s.helm.chart import HelmChart
...
class K8sResources(InfraResources):
    ...
    def create_resources(
        ...
        from src.backend.kr8.cli.console import print_info, print_heading, confirm_yes_no
        from src.backend.kr8.k8s.resource.types import K8sResourceInstallOrder
