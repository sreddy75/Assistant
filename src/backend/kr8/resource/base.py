...
from src.backend.kr8.base import PhiBase
...
class ResourceBase(PhiBase):
    ...
    def get_input_file_path(self) -> Optional[Path]:
        ...
        if workspace_dir is None:
            from src.backend.kr8.workspace.helpers import get_workspace_dir_from_env
    ...
    def save_output_file(self) -> bool:
        ...
        if output_file_path is not None:
            try:
                from src.backend.kr8.utils.yaml_io import write_yaml_file
    ...
    def read_resource_from_file(self) -> Optional[Dict[str, Any]]:
        ...
        if output_file_path is not None:
            try:
                from src.backend.kr8.utils.yaml_io import read_yaml_file
