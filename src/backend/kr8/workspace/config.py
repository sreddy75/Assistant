...
from src.backend.kr8.api.schemas.workspace import WorkspaceSchema
from src.backend.kr8.workspace.settings import WorkspaceSettings
from src.backend.kr8.utils.py_io import get_python_objects_from_module
...
def get_workspace_objects_from_file(resource_file: Path) -> dict:
    ...
    try:
        ...
        if not docker_resources_available and create_default_docker_resources:
            from src.backend.kr8.docker.resources import DockerResources, DockerResource, DockerApp
        ...
        if not k8s_resources_available and create_default_k8s_resources:
            from src.backend.kr8.k8s.resources import K8sResources, K8sResource, K8sApp, CreateK8sResource
        ...
        if not aws_resources_available and create_default_aws_resources:
            from src.backend.kr8.aws.resources import AwsResources, AwsResource, AwsApp
