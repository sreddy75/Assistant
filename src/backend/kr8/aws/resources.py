...
from src.backend.kr8.aws.app.base import AwsApp
from src.backend.kr8.aws.app.context import AwsBuildContext
from src.backend.kr8.aws.api_client import AwsApiClient
...
class AwsResources(InfraResources):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from src.backend.kr8.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from os import getenv
        from src.backend.kr8.constants import AWS_PROFILE_ENV_VAR
    ...
    def create_resources(
        ...
        from src.backend.kr8.aws.resource.types import AwsResourceInstallOrder
