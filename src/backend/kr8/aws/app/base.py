...
from src.backend.kr8.app.base import AppBase  # noqa: F401
from src.backend.kr8.app.context import ContainerContext
from src.backend.kr8.aws.app.context import AwsBuildContext
...
if TYPE_CHECKING:
    ...
    from src.backend.kr8.aws.resource.ecs.container import EcsContainer
...
class AwsApp(AppBase):
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from src.backend.kr8.aws.resource.ec2.security_group import SecurityGroup, InboundRule
    ...
    def security_group_definition(self) -> "SecurityGroup":
        from src.backend.kr8.aws.resource.ec2.security_group import SecurityGroup, InboundRule
        from src.backend.kr8.aws.resource.reference import AwsReference
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from src.backend.kr8.aws.resource.ecs.task_definition import EcsTaskDefinition
        from src.backend.kr8.aws.resource.ecs.service import EcsService
        from src.backend.kr8.aws.resource.ecs.volume import EcsVolume
        from src.backend.kr8.docker.resource.image import DockerImage
        from src.backend.kr8.utils.defaults import get_default_volume_name
