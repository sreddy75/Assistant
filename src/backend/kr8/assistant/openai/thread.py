...
from src.backend.kr8.assistant.openai.run import Run
from src.backend.kr8.assistant.openai.message import Message
from src.backend.kr8.assistant.openai.assistant import OpenAIAssistant
from src.backend.kr8.assistant.openai.exceptions import ThreadIdNotSet
...
class Thread(BaseModel):
    ...
    def print_messages(self) -> None:
        ...
        from src.backend.kr8.cli.console import console
