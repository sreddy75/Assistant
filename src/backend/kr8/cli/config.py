...
from src.backend.kr8.cli.console import print_heading, print_info
from src.backend.kr8.cli.settings import phi_cli_settings
from src.backend.kr8.api.schemas.user import UserSchema
from src.backend.kr8.api.schemas.workspace import WorkspaceSchema, WorkspaceDelete
...
class PhiCliConfig:
    ...
    def delete_ws(self, ws_root_path: Path) -> None:
        ...
        if self.user is not None and ws_config.ws_schema is not None:
            ...
            from src.backend.kr8.api.workspace import delete_workspace_for_user
