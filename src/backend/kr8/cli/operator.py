...
from src.backend.kr8.cli.settings import phi_cli_settings, PHI_CLI_DIR
from src.backend.kr8.cli.config import PhiCliConfig
from src.backend.kr8.cli.console import print_info, print_heading
...
def delete_phidata_conf() -> None:
    from src.backend.kr8.utils.filesystem import delete_from_fs
...
def authenticate_user() -> None:
    ...
    """
    from src.backend.kr8.api.user import authenticate_and_get_user
    from src.backend.kr8.api.schemas.user import UserSchema
    from src.backend.kr8.cli.auth_server import (
...
def sign_in_using_cli() -> None:
    ...
    from src.backend.kr8.api.user import sign_in_user
    from src.backend.kr8.api.schemas.user import UserSchema, EmailPasswordAuthSchema
